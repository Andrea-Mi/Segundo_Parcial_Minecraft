...
namespace MinecraftSP.Services
{
    public class BloqueService
    {
        ...
        public List<Bloque> ObtenerTodos()
        {
            ...
            {
                connection.Open();
                var query = "SELECT Id, Nombre, Tipo, Rareza FROM Bloques";
        ...
        public List<Bloque> BuscarPorRareza(string rareza)
        {
            ...
            {
                connection.Open();
                var query = "SELECT Id, Nombre, Tipo, Rareza FROM Bloques WHERE Rareza = @Rareza";
                using (var command = new SqlCommand(query, connection))
                {
